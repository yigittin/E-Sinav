...
namespace SanalVaka.Migrations
{
    ...
    [Migration("20230608141142_SoruCevaplarOgrenciId")]
    partial class SoruCevaplarOgrenciId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OgrenciSinif", b =>
                {
                    ...
                    b.HasKey("SinifOgrencilerId", "SiniflarId");
            ...
            modelBuilder.Entity("SanalVaka.Many2Many.BolumYetkili", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SanalVaka.Many2Many.DersYetkili", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SanalVaka.Many2Many.SinifOgrenci", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SinifOgrenciler");
                });

            modelBuilder.Entity("SanalVaka.Many2Many.SinifYetkili", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SanalVaka.Many2Many.SoruCevap", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SanalVaka.Ogrenciler.OgrenciCevap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OgrenciSinavId");

                    b.ToTable("OgrenciCevaplar");
                });

            modelBuilder.Entity("SanalVaka.Ogrenciler.OgrenciSinav", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OgrenciSinavlar");
                });

            modelBuilder.Entity("SanalVaka.Sinavlar.Sinav", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SanalVaka.Sorular.Cevap", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SanalVaka.Sorular.Soru", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentityUser", b =>
                {
                    ...
                    b.Property<bool>("Yetkili")
                        .HasColumnType("bit");

                    b.Property<string>("YetkiliNo")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("OgrenciSinif", b =>
                {
                    b.HasOne("SanalVaka.Ogrenciler.Ogrenci", null)
                        .WithMany()
                        .HasForeignKey("SinifOgrencilerId")
            ...
            modelBuilder.Entity("SanalVaka.Ogrenciler.OgrenciCevap", b =>
                {
                    b.HasOne("SanalVaka.Ogrenciler.OgrenciSinav", null)
                        .WithMany("ogrenciCevaplar")
                        .HasForeignKey("OgrenciSinavId");
                });
            ...
            modelBuilder.Entity("SanalVaka.Sorular.Cevap", b =>
                {
                    b.HasOne("SanalVaka.Sorular.Soru", "Soru")
                        .WithMany("CevapList")
            ...
            modelBuilder.Entity("SanalVaka.Sorular.Soru", b =>
                {
                    b.HasOne("SanalVaka.Sinavlar.Sinav", "Sinav")
                        .WithMany("SoruList")
            ...
            modelBuilder.Entity("SanalVaka.Ogrenciler.OgrenciSinav", b =>
                {
                    b.Navigation("ogrenciCevaplar");
                });

            modelBuilder.Entity("SanalVaka.Sinavlar.Sinav", b =>
                {
                    b.Navigation("SoruList");
                });
